...
class GameMainWindow():
    ...
    ### zerowanie po nowej rozgrywce zwykłych punktów i kart, widocznych na ekranie:
...
def open_game_rules_window():
    ...
    rules_main_text = Label(game_rules_window, text = 'Gracz i komputer losują karty (z talii od dziewiątek do asów), otrzymując punkty: za dziewiątkę - 0, dziesiątkę - 10, waleta - 2, damę - 3, króla - 4, asa - 11. \nZadaniem obu jest zgromadzenie możliwie największej ilości punktów w kartach, jednakże nie przekraczającej 21. \nOczko gracza (tj. 21 punktów w kartach lub perskie, czyli dwa asy w dwóch pierwszych kartach) powoduje zwycięstwo w rozdaniu i uzyskanie przez niego dużego punktu. \nOczko komputera to wygrane przez niego rozdanie. W przypadku przekroczenia 21 punktów delikwent (zarówno gracz, jak i komputer) automatycznie przegrywa rozdanie, a jego rywal zyskuje duży punkt. \nJeśli gracz i komputer uzyskali poniżej 21 punktów, wygrywa ten który zebrał ich więcej, a w przypadku uzyskania równej ilości punktów przez obu, oboje zyskują duży punkt. \nKomputer mając 15 punktów w kartach musi wziąć kartę, zaś przy 18 musi zakończyć dobieranie kart. Gracza nie obowiązują ograniczenia z poprzedniego punktu. \nGra kończy się po 21 wygranych rozdaniach (przez gracza lub komputer). Pojedyncza gra nie może trwać dłużej niż 60 minut (czas zalogowania)', font = ("Times New Roman", 11), foreground = 'white', background = 'black')
